  ...
  return (
    <div>
      ...
      <p>
        ...
        of expenses's Website, located at https://smart-expense-one.vercel.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Expenses if you do not agree to take
      ...
      <p>
        ...
        subject to, prevailing law of vn. Any use of the above terminology or
      ...
      <p>
        Unless otherwise stated, expenses and/or its licensors own the
        intellectual property rights for all material on Expenses. All
        intellectual property rights are reserved. You may access this from
        Expenses for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Expenses</li>
        <li>Sell, rent or sub-license material from Expenses</li>
        <li>Reproduce, duplicate or copy material from Expenses</li>
        <li>Redistribute content from Expenses</li>
      </ul>
      ...
      <p>
        ...
        expenses does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of expenses,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, expenses shall not be liable
      ...
      <p>
        expenses reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant expenses a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of expenses; and (d) the link is
      ...
      <p>
        ...
        e-mail to expenses. Please include your name, your organization name,
      ...
      <p>
        No use of expenses's logo or other artwork will be allowed for linking
